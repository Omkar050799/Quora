...
from quora_app.serializers.change_password_serializer import ChangePasswordSerializer
from oauth2_provider.contrib.rest_framework import OAuth2Authentication
from rest_framework.permissions import IsAuthenticated
from utility.response import ApiResponse

from quora.permissions import is_access
from utility.utils import CreateRetrieveUpdateViewSet

"""swagger"""
from ..swagger.change_password_swagger import swagger_auto_schema

class ChangePasswordView(CreateRetrieveUpdateViewSet, ApiResponse):
        ...
        try:
            ...
            if user.check_password(data.get("old_password")):
                if data.get("password") != data.get("confirm_password"):
                    return ApiResponse.response_bad_request(self, message="Password and confirm password does not match")
