...
swagger_auto_schema_list = swagger_auto_schema(
    manual_parameters=[
        ...
        Parameter(
            "name", IN_QUERY, description="search by name of the city", type="char"
        ),
        Parameter("state", IN_QUERY, description="state id parameter", type="int"),
    ],
    responses={
    ...
    operation_id="list cities",
    operation_description="API to list cities data",
)
