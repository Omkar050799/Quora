...
swagger_auto_schema_list = swagger_auto_schema(
    ...
    operation_id="List answers",
    operation_description="API to list answers data",
)
...
swagger_auto_schema_post = swagger_auto_schema(
    ...
    operation_description="API to add new answer",
    request_body=Schema(
        type=TYPE_OBJECT,
        properties={
            "answer": Schema(type=TYPE_STRING),
            "user": Schema(type=TYPE_INTEGER),
            "question": Schema(type=TYPE_INTEGER),
        },
    ),
)
...
swagger_auto_schema_update = swagger_auto_schema(
    ...
    operation_description="""API to update answer""",
    request_body=Schema(
        type=TYPE_OBJECT,
        properties={
            "answer": Schema(type=TYPE_STRING),
...
swagger_auto_schema_delete = swagger_auto_schema(
    ...
    operation_description="API to delete answer",
)
...
swagger_auto_schema = swagger_auto_schema(
    ...
    operation_id="Get answer",
    operation_description="API to get answer",
)
